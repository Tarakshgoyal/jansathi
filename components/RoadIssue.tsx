      ...
      <VStack className="flex-1 p-4" space="lg">
        <VStack space="sm">
          <Heading size="xl" className="text-typography-900">
            {getText(t.issueTypes.sadakSamasya)}
          </Heading>
          <Text size="sm" className="text-typography-500">
            Report road-related issues in your area
          </Text>
        </VStack>
        ...
        {/* Road issue form will be added here */}
        <VStack space="sm">
