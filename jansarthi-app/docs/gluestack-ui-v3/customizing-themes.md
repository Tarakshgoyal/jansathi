...
pageDescription: Customize your UI theme in gluestack-ui v3 by defining a theme config and applying it via GluestackUIProvider. Tailwind CSS theme support lets you style your app seamlessly.
...
Customize your UI theme in gluestack-ui v3 by defining a theme config and applying it via GluestackUIProvider. Tailwind CSS theme support lets you style your app seamlessly.

<br />

## Customizing Tokens

gluestack-ui v3, seamlessly accommodates the default Tailwind CSS [theme](https://tailwindcss.com/docs/theme), allowing users to effortlessly expand and customize it to suit their needs.

gluestack-ui v3 also ships with a set of handpicked default color palette tokens which are mapped separately with each mode. For example, the default color palette for light mode is `light` and the default color palette for dark mode is `dark`.
